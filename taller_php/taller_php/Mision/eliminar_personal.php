    ...
    <div class="contenedor">
        ...
        <?php
			 ...
			 if (isset($_POST['eliminar'])) {
				...
				$queryDelete = "DELETE FROM personal WHERE rut = ?";
				$prepareDelete = mysqli_prepare($conexion, $queryDelete);
				mysqli_stmt_bind_param($prepareDelete, "s", $eliminar);
				mysqli_stmt_execute($prepareDelete);
				header('Location: eliminar_personal.php?mensajeEliminar=si');
			}	
			};

			if($_GET['mensajeEliminar'] == "si"){
				echo "<p class='mensaje'> Datos eliminados correctamente</p>";
