...
<body>
    <form method="POST" class="form" style="padding: 100px 300px 0 300px; width: 100%;">
        <h2 style="text-align: center;">Editar Publicación</h2><br>
        <div class="row">
            <div class="col">
                ...
                <label for="rut" style="text-align: center;">Publicación:</label>
                <input type="text" class="form-control" name="NombreCarrera" placeholder="Esta es una Publicación" Required><br>
