...
class PerfilController
{
    ...
    //         if ($campo !== 'experienciasLaborales') { // Excluir el campo 'experienciasLaborales'
    ...
    public function guardarDatosAlumno()
    {
        ...
        $camposModificados = [];
        foreach ($_POST as $campo => $valor) {
            if ($campo !== 'experienciasLaborales' && $campo !== 'experienciasAcademicas') { // Excluir los campos de experiencias laborales y académicas
                $camposModificados[$campo] = $valor;
            }
        }
